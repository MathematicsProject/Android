...
public class CropWindow {
    ...
    public CropWindow(RectF imageRect, MainActivity.CropParam params) {
    ...
    public void setRateW(Float rateW) {
        this.rateW = rateW;
    }
    public void setRateH(Float rateH) {
        this.rateH = rateH;
    }
    ...
    public Rect getWindowRect(float scale) {
        int width   = (int)(width()/rateW);
        int height  = (int)(height()/rateH);
        int xoffset = (int)((left()-mImageRect.left)/rateW);
        int yoffset = (int)((top()-mImageRect.top)/rateH);
